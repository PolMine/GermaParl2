--- 
title: "The GermaParl Corpus of Plenary Protocols (v2.0.0) - Documentation"
...
* Cite corpus as: Blaette, Andreas, & Leonhardt, Christoph (2023). GermaParl Corpus of Plenary Protocols (v2.0.0) [Data set]. Zenodo. https://doi.org/10.5281/zenodo.7949074.

* Cite documentation as: Blaette, Andreas, & Leonhardt, Christoph (2023). The GermaParl Corpus of Plenary Protocols (v2.0.0) - Documentation. Version `r Sys.Date()`. https://polmine.github.io/BuildingGermaParl.
::::
...
:::: {.blackbox data-latex=""}
_Note:_ This documentation is provided as both a website and a pdf document (realized with the bookdown R package [@Yihui2016]). When referring to this documentation, please quote the pdf version as

Blaette, Andreas, & Leonhardt, Christoph (2023). The GermaParl Corpus of Plenary Protocols (v2.0.0) - Documentation. Version `r Sys.Date()`. https://polmine.github.io/BuildingGermaParl.
::::
...
:::: {.blackbox data-latex=""}
Blaette, Andreas, & Leonhardt, Christoph (2023). GermaParl Corpus of Plenary Protocols (v2.0.0) [Data set]. Zenodo. https://doi.org/10.5281/zenodo.7949074.
::::
...
The TEI/XML version of the corpus is stored on GitHub. As these files also provide the basis for the CWB corpus, the respective repository is the natural location to collect feedback. The repository can be found here: https://github.com/PolMine/GermaParlTEI.
